...
def cancelar_produto():
    ...
    7      | Suco natural         | R$ 6,25 \n""")
                        ...
                        if codigo_produto == "1":
                                ...
                                if total_prod1 - quantidade_produto >= 0:
                                        total -= valor
                                        total_prod1 -= quantidade_produto
                                        ext_user.write("X-salada         | Quantidade: %i | Preço unitário: R$ 10,00 | Valor: R$ -%.2f | Cancelado\n" %  (quantidade_produto, valor))
                                else:
                                        print("Produto que você tentou cancelar não existe dentro do seu pedido ou ultrapassa o seu pedido atual.")
                        elif codigo_produto == "2":
                                valor = quantidade_produto * 10.00
                                if total_prod2 - quantidade_produto >= 0:
                                        total -= valor
                                        total_prod2 -= quantidade_produto
                                        ext_user.write("X-burguer        | Quantidade: %i | Preço unitário: R$ 10,00 | Valor: R$ -%.2f | Cancelado\n" %  (quantidade_produto, valor))
                                else:
                                        print("Produto que você tentou cancelar não existe dentro do seu pedido ou ultrapassa o seu pedido atual.")    
                        elif codigo_produto == "3":
                                valor = quantidade_produto * 7.50
                                if total_prod3 - quantidade_produto >= 0:
                                        total -= valor
                                        total_prod3 -= quantidade_produto
                                        ext_user.write("Cachorro quente  | Quantidade: %i | Preço unitário: R$ 7,50  | Valor: R$ -%.2f | Cancelado\n" %  (quantidade_produto, valor))
                                else: 
                                        print("Produto que você tentou cancelar não existe dentro do seu pedido ou ultrapassa o seu pedido atual.")    
                        elif codigo_produto == "4":
                                valor = quantidade_produto * 8.00
                                if total_prod4 - quantidade_produto >= 0:
                                        total -= valor
                                        total_prod4 -= quantidade_produto
                                        ext_user.write("Misto quente     | Quantidade: %i | Preço unitário: R$ 8,00  | Valor: R$ -%.2f | Cancelado\n" %  (quantidade_produto, valor))
                                else: 
                                        print("Produto que você tentou cancelar não existe dentro do seu pedido ou ultrapassa o seu pedido atual.")           
                        elif codigo_produto == "5":
                                valor = quantidade_produto * 5.50
                                if total_prod5 - quantidade_produto >= 0:
                                        total -= valor
                                        total_prod5 -= quantidade_produto
                                        ext_user.write("Salada de frutas | Quantidade: %i | Preço unitário: R$ 5,50  | Valor: R$ -%.2f | Cancelado\n" %  (quantidade_produto, valor))
                                else: 
                                        print("Produto que você tentou cancelar não existe dentro do seu pedido ou ultrapassa o seu pedido atual.")            
                        elif codigo_produto == "6":
                                valor = quantidade_produto * 4.50
                                if total_prod6 - quantidade_produto >= 0:
                                        total -= valor
                                        total_prod6 -= quantidade_produto
                                        ext_user.write("Refrigerante     | Quantidade: %i | Preço unitário: R$ 4,50  | Valor: R$ -%.2f | Cancelado\n" %  (quantidade_produto, valor))
                                else: 
                                        print("Produto que você tentou cancelar não existe dentro do seu pedido ou ultrapassa o seu pedido atual.")          
                        elif codigo_produto == "7":
                                valor = quantidade_produto * 6.25
                                if total_prod7 - quantidade_produto >= 0:
                                        total -= valor
                                        total_prod7 -= quantidade_produto
                                        ext_user.write("Suco natural     | Quantidade: %i | Preço unitário: R$ 6,25  | Valor: R$ -%.2f | Cancelado\n" %  (quantidade_produto, valor))
                                else: 
                                        print("Produto que você tentou cancelar não existe dentro do seu pedido ou ultrapassa o seu pedido atual.")        
                        else:
                        ...
                        novo_produto = input("Deseja cancelar outro produto? (S/N)")
